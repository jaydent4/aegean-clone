# social_compose_pbeo Service Topology

Source: [../architecture/social_compose_pbeo.yaml](../architecture/social_compose_pbeo.yaml)
...
flowchart LR
  ...
  social_graph["social_graph<br/>pbeo"]
