...
func InitStateOpt(e *optexec.Exec) map[string]string {
	_ = e
	return map[string]string{}
}

func ExecuteRequestBackendOpt(e *optexec.Exec, request map[string]any, ndSeed int64, ndTimestamp float64) map[string]any {
	_ = e
	_ = ndSeed
	_ = ndTimestamp
...
func ExecuteRequestMiddleOpt(e *optexec.Exec, request map[string]any, ndSeed int64, ndTimestamp float64) map[string]any {
	_ = ndSeed
	_ = ndTimestamp
