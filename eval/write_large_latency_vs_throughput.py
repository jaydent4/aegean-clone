...
OUTPUT_PATH = RESULTS_ROOT / "write_large" / "latency_vs_throughput.png"

SERIES = [
    ("Aegean", RESULTS_ROOT / "write_large_aegean", [1, 2, 3, 4], "#08306b"),
    ("Aegean+EO", RESULTS_ROOT / "write_large_aegean_eo", [3, 5, 7], "#6baed6"),
    ("Unreplicated", RESULTS_ROOT / "write_large_unreplicated", [3, 5, 7], "#555555"),
]
...
def main() -> int:
    ...
    ax.set_title("Write Large Latency vs Realized Throughput")
    ax.set_xlim(left=0)
    ax.set_ylim(0, 2000)
