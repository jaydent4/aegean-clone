...
OUTPUT_PATH = RESULTS_ROOT / "response_large_aegean" / "latency_vs_throughput.png"

SERIES = [
    (
        "Aegean",
        RESULTS_ROOT / "response_large_aegean",
        [60, 120, 170, 180, 185],
        "#08306b",
    ),
    (
        "Aegean+EO",
        RESULTS_ROOT / "response_large_aegean_eo",
        [60, 120, 140, 145],
        "#6baed6",
    ),
    (
        "PBEO",
        RESULTS_ROOT / "response_large_pbeo",
        [150, 300, 350, 400],
        "#238b45",
    ),
    (
        "Unreplicated",
        RESULTS_ROOT / "response_large_unreplicated",
        [300, 600, 700],
        "#555555",
    ),
]
